...
Процедура Заполнить(Команда)
	...
	Если ВариантЗаполнения = "ПоОтбору" 
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Не заполнено поле ""Магазин""'"), , "Объект.Магазин", , Отказ);
		Возврат;
	КонецЕсли;

	Если ВариантЗаполнения = "ПоОтбору" И ИспользоватьАссортимент 
		И НЕ ЗначениеЗаполнено(Объект.ФорматМагазина) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'У выбранного магазина не заполнено поле ""Формат магазина""'"), , "Объект.Магазин", , Отказ);
		Возврат;
	КонецЕсли;
	...
	Если ВариантЗаполнения = "ПоДокументу"
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Не заполнено поле ""Документ""'"), , "Документ", , Отказ);
		Возврат;
	КонецЕсли;
...
Процедура МагазинПриИзмененииСервер()
	...
	Если ИспользоватьАссортимент И НЕ ЗначениеЗаполнено(Объект.ФорматМагазина) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'У выбранного магазина не заполнено поле ""Формат магазина""'"), , "Объект.Магазин", ,);
	КонецЕсли;
