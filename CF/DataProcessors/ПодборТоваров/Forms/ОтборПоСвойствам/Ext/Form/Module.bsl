...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МассивКатегорийНоменклатуры = ПодборТоваровВызовСервера.ПолучитьОбщиеСвойстваНоменклатуры();
	...
	МассивСтруктурСвойствИЗначений = ПодборТоваровВызовСервера.ПолучитьСвойстваВидаНоменклатуры(Параметры.ВидНоменклатуры);
