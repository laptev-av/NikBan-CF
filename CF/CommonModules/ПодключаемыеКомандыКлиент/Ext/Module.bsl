...
Процедура ВыполнитьКоманду(Форма, Команда, Источник) Экспорт
	...
	Если ТипЗнч(Команда) = Тип("Структура") Тогда
		...
		ОписаниеКоманды.МножественныйВыбор = Истина;
		Контекст.ОписаниеКоманды = ОписаниеКоманды;
		Контекст.ЭтоФормаОбъекта = ОписаниеКоманды.ЭтоФормаОбъекта;
		Контекст.Вставить("ТребуетсяОпределитьСсылки", Ложь);
		МассивСсылок = Новый Массив;
		МассивСсылок.Добавить(Источник);
		Контекст.Вставить("МассивСсылок", МассивСсылок);
		Контекст.Вставить("ОбъектыПечати", МассивСсылок);
