...
Функция ИмяСобытияЗаписиПоступленияТоваров() Экспорт
	...
	Возврат "Запись_ПоступлениеТоваров";
...
Функция РеквизитыНоменклатурыДляВыбораАлкогольнойПродукции(Номенклатура) Экспорт
	...
	Реквизиты.ВидАлкогольнойПродукции = ОбщегоНазначенияРТВызовСервера.ЗначениеРеквизитаОбъекта(Номенклатура,"ВидАлкогольнойПродукции");
