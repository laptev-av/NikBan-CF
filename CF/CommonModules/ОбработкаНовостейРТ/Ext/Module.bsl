...
Процедура ЗаполнитьОтборыНовостей() Экспорт
	...
	Если ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
		Если ОбщегоНазначенияПовтИсп.СеансЗапущенБезРазделителей() Тогда
			...
			ТекстСообщения = НСтр("ru='Вызов ОбработкаНовостейРТ.ЗаполнитьОтборыНовостей() в модели сервиса в неразделённом сеансе не поддерживается.'");
			// Запись в журнал регистрации
			ЗаписьЖурналаРегистрации(
				НСтр("ru='Новости. Переопределяемый. Обновление ИБ. ЗаполнитьОтборыНовостей'"), // ИмяСобытия
