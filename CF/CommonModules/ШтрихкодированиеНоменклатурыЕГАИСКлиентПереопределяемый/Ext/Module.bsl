...
Функция ПодготовитьДанныеДляОбработкиШтрихкодов(Форма, ДанныеШтрихкодов, КэшированныеЗначения, ПараметрыЗаполнения) Экспорт
	...
	СтруктураДействийСДобавленнымиСтроками.Вставить("ЗаполнитьАлкогольнуюПродукцию");
	...
	Если ТипЗнч(ДанныеШтрихкодов) <> Тип("Массив") Тогда
		...
		Штрихкоды.Добавить(ДанныеШтрихкодов);
	Иначе
		Штрихкоды = ДанныеШтрихкодов;
	КонецЕсли;
	
	СтруктураДействий = Новый Структура;
	
	СтруктураДействий.Вставить("Штрихкоды"                             , Штрихкоды);
	СтруктураДействий.Вставить("СтруктураДействийСДобавленнымиСтроками", СтруктураДействийСДобавленнымиСтроками);
	СтруктураДействий.Вставить("СтруктураДействийСИзмененнымиСтроками" , СтруктураДействийСИзмененнымиСтроками);
	СтруктураДействий.Вставить("ШтрихкодыВТЧ"                          , ПараметрыЗаполнения.ШтрихкодыВТЧ);
	СтруктураДействий.Вставить("МаркируемаяАлкогольнаяПродукцияВТЧ"    , ПараметрыЗаполнения.МаркируемаяАлкогольнаяПродукцияВТЧ);
