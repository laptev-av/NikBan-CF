...
Функция ПолучитьМассивКиз(СписокНоменклатураКиЗ, GTIN) Экспорт
	Возврат МаркировкаТоваровГИСМВызовСервераРТ.ПолучитьМассивКиз(СписокНоменклатураКиЗ, GTIN);
КонецФункции
...
Функция МассивGTINМаркированногоТовара(Номенклатура, Характеристика) Экспорт
	...
	Возврат МаркировкаТоваровГИСМВызовСервераРТ.МассивGTINМаркированногоТовара(Номенклатура, Характеристика);
