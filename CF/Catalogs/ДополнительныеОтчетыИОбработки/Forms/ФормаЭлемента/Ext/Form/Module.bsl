...
Процедура УстановитьВидимостьДоступность(Регистрация = Ложь)
	...
	Если Объект.Вид = Перечисления.ВидыДополнительныхОтчетовИОбработок.РасчетСкидки
		ИЛИ Объект.Вид = Перечисления.ВидыДополнительныхОтчетовИОбработок.ПроверкаУсловияПредоставленияСкидки Тогда
		Элементы.РазмещениеКоманд.Видимость = Ложь;
		Элементы.ГруппаРазмещение.Видимость = Ложь;
		Элементы.ТипыФорм.Видимость = Ложь;
		Элементы.НастроитьВидимость.Видимость = Ложь;
		Элементы.ОбъектКомандыКомментарий.Видимость = Ложь;
	Иначе
